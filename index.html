...
<head>
    ...
    <style>
    :root { --bg: #050505; --yellow: #FFDE00; --text: #ffffff; --gray: #7F7F7F; --dark-card: rgba(15, 15, 15, 0.95); }
    ...
    #topBtn { position: fixed; bottom: 30px; right: 30px; z-index: 99; background: var(--yellow); color: #000; border: none; border-radius: 50%; width: 50px; height: 50px; cursor: pointer; display: none; font-weight: bold; }

    @media (max-width: 768px) { .form-row { flex-direction: column; } .nav-links { display: none; } }
    </style>
</head>
<body>

    <nav>
       <div class="nav-logo"><img src="/images/nav-logo.png" alt="Logo"></div>
        <div class="nav-links">
    ...
    <footer>
        <div class="container">
            ...
            <p>© <span id="year"></span> {{ site.data.site.producer_name }}. All Rights Reserved.</p>
        </div>
    </footer>
